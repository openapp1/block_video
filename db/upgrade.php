...
function xmldb_block_video_upgrade($oldversion) {
    ...
    if ($oldversion < 2020090700) {
        ...
        $table = new xmldb_table('block_video_course');
        ...
        $table->add_field('usermodifiedid', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, null);
        $table->add_field('timemodified', XMLDB_TYPE_INTEGER, '20', null, null, null, null);

        // Adding keys to table block_video_course.
        ...
        upgrade_plugin_savepoint(true, 2020090700, 'block', 'video');
    }
    return 1;
}
